...
package org.omoa.spacemodel.iterator {
	...
	/**
	 * Iterates over the entities of s SpaceModel that are outside a
	...
	public class OutsideBoxIterator extends SimpleIterator
	{
		private var _originalEntities:Vector.<SpaceModelEntity>;
		
		public function OutsideBoxIterator(entities:Vector.<SpaceModelEntity> = null) 
		{
		...
		public function init( boundingBox:BoundingBox ):void {
			...
			for each (sme in _originalEntities) {
				...
				//if (!boundingBox.containsRect(sme.bounds as BoundingBox)) {
